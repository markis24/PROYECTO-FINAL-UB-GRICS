                ...
                <form action="{{ route('membres.update',$membre->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div class="grid grid-cols-1">
                            ...
                            <input name="nombre" value="{{ $membre->name }}"
                        ...
                        <div class="grid grid-cols-1 mb-8 ">
                            ...
                            <input name="descripcion" value="{{ $membre->description }}"
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <input name="email" value="{{ $membre->email }}"
                                   class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                   type="email" required/>
                        </div>
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Links:</label>
                            <input name="links" value="{{ $membre->links }}"
                                   class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                   type="url" required/>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        <img src="/imagen/{{ $membre->imagen }}" width="200px" id="imagenSeleccionada">
                    </div>
